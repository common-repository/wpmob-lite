...
touchJS( document ).ready( function() { 
    doReady(); 
    // Other Header Menu Toggle (toggle button animation and menu showing)
  touchJS('#navigate').click(function(){
    if ( ! touchJS('#menu').is(':animated'))
      touchJS('#menu').slideToggle(300);
  }); 
} );
